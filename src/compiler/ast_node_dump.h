...
ow_noinline static void print_node_line(
		size_t level, struct ow_stream *out, const char *fmt, ...) {
	char buffer[128];
...
ow_noinline static void print_node_end_tag(
		const char *name, size_t level, struct ow_stream *out) {
	print_node_line(level, out, "</%s>", name);
}
...
static void ow_ast_node_dump(const struct ow_ast_node *, size_t, struct ow_stream *);

#define ELEM(NAME) \
	static void ow_ast_##NAME##_dump( \
		const struct ow_ast_##NAME *, size_t, struct ow_stream *);
OW_AST_NODE_LIST
#undef ELEM

static void ow_ast_NilLiteral_dump(
		const struct ow_ast_NilLiteral *node, size_t level, struct ow_stream *out) {
...
static void ow_ast_BoolLiteral_dump(
		const struct ow_ast_BoolLiteral *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_IntLiteral_dump(
		const struct ow_ast_IntLiteral *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_FloatLiteral_dump(
		const struct ow_ast_FloatLiteral *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_StringLikeLiteral_dump(
		const struct ow_ast_StringLikeLiteral *node, size_t level, struct ow_stream *out) {
	char string[64];
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
...
static void ow_ast_SymbolLiteral_dump(
		const struct ow_ast_SymbolLiteral *node, size_t level, struct ow_stream *out) {
	ow_ast_StringLikeLiteral_dump((const struct ow_ast_StringLikeLiteral *)node, level, out);
}

static void ow_ast_StringLiteral_dump(
		const struct ow_ast_StringLiteral *node, size_t level, struct ow_stream *out) {
	ow_ast_StringLikeLiteral_dump((const struct ow_ast_StringLikeLiteral *)node, level, out);
}

static void ow_ast_Identifier_dump(
		const struct ow_ast_Identifier *node, size_t level, struct ow_stream *out) {
	ow_ast_StringLikeLiteral_dump((const struct ow_ast_StringLikeLiteral *)node, level, out);
}

static void ow_ast_BinOpExpr_dump(
		const struct ow_ast_BinOpExpr *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_AddExpr_dump(
		const struct ow_ast_AddExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_SubExpr_dump(
		const struct ow_ast_SubExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_MulExpr_dump(
		const struct ow_ast_MulExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_DivExpr_dump(
		const struct ow_ast_DivExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_RemExpr_dump(
		const struct ow_ast_RemExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_ShlExpr_dump(
		const struct ow_ast_ShlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_ShrExpr_dump(
		const struct ow_ast_ShrExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_BitAndExpr_dump(
		const struct ow_ast_BitAndExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_BitOrExpr_dump(
		const struct ow_ast_BitOrExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_BitXorExpr_dump(
		const struct ow_ast_BitXorExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_EqlExpr_dump(
		const struct ow_ast_EqlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_AddEqlExpr_dump(
		const struct ow_ast_AddEqlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_SubEqlExpr_dump(
		const struct ow_ast_SubEqlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_MulEqlExpr_dump(
		const struct ow_ast_MulEqlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_DivEqlExpr_dump(
		const struct ow_ast_DivEqlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_RemEqlExpr_dump(
		const struct ow_ast_RemEqlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_ShlEqlExpr_dump(
		const struct ow_ast_ShlEqlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_ShrEqlExpr_dump(
		const struct ow_ast_ShrEqlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_BitAndEqlExpr_dump(
		const struct ow_ast_BitAndEqlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_BitOrEqlExpr_dump(
		const struct ow_ast_BitOrEqlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_BitXorEqlExpr_dump(
		const struct ow_ast_BitXorEqlExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_EqExpr_dump(
		const struct ow_ast_EqExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_NeExpr_dump(
		const struct ow_ast_NeExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_LtExpr_dump(
		const struct ow_ast_LtExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_LeExpr_dump(
		const struct ow_ast_LeExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_GtExpr_dump(
		const struct ow_ast_GtExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_GeExpr_dump(
		const struct ow_ast_GeExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_AndExpr_dump(
		const struct ow_ast_AndExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_OrExpr_dump(
		const struct ow_ast_OrExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_AttrAccessExpr_dump(
		const struct ow_ast_AttrAccessExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_MethodUseExpr_dump(
		const struct ow_ast_MethodUseExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_BinOpExpr_dump((const struct ow_ast_BinOpExpr *)node, level, out);
}

static void ow_ast_UnOpExpr_dump(
		const struct ow_ast_UnOpExpr *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_PosExpr_dump(
		const struct ow_ast_PosExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_UnOpExpr_dump((const struct ow_ast_UnOpExpr *)node, level, out);
}

static void ow_ast_NegExpr_dump(
		const struct ow_ast_NegExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_UnOpExpr_dump((const struct ow_ast_UnOpExpr *)node, level, out);
}

static void ow_ast_BitNotExpr_dump(
		const struct ow_ast_BitNotExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_UnOpExpr_dump((const struct ow_ast_UnOpExpr *)node, level, out);
}

static void ow_ast_NotExpr_dump(
		const struct ow_ast_NotExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_UnOpExpr_dump((const struct ow_ast_UnOpExpr *)node, level, out);
}

static void ow_ast_CallExpr_dump(
		const struct ow_ast_CallExpr *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_SubscriptExpr_dump(
		const struct ow_ast_SubscriptExpr *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_ArrayLikeExpr_dump(
		const struct ow_ast_ArrayLikeExpr *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_TupleExpr_dump(
		const struct ow_ast_TupleExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_ArrayLikeExpr_dump((struct ow_ast_ArrayLikeExpr *)node, level, out);
}

static void ow_ast_ArrayExpr_dump(
		const struct ow_ast_ArrayExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_ArrayLikeExpr_dump((struct ow_ast_ArrayLikeExpr *)node, level, out);
}

static void ow_ast_SetExpr_dump(
		const struct ow_ast_SetExpr *node, size_t level, struct ow_stream *out) {
	ow_ast_ArrayLikeExpr_dump((struct ow_ast_ArrayLikeExpr *)node, level, out);
}

static void ow_ast_MapExpr_dump(
		const struct ow_ast_MapExpr *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_LambdaExpr_dump(
		const struct ow_ast_LambdaExpr *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_ExprStmt_dump(
		const struct ow_ast_ExprStmt *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_BlockStmt_dump(
		const struct ow_ast_BlockStmt *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_ReturnStmt_dump(
		const struct ow_ast_ReturnStmt *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_MagicReturnStmt_dump(
		const struct ow_ast_MagicReturnStmt *node, size_t level, struct ow_stream *out) {
	ow_ast_ReturnStmt_dump((const struct ow_ast_ReturnStmt *)node, level, out);
}

static void ow_ast_ImportStmt_dump(
		const struct ow_ast_ImportStmt *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_IfElseStmt_dump(
		const struct ow_ast_IfElseStmt *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_ForStmt_dump(
		const struct ow_ast_ForStmt *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_WhileStmt_dump(
		const struct ow_ast_WhileStmt *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
	print_node_begin_tag("cond", NULL, level + 1, out);
...
static void ow_ast_FuncStmt_dump(
		const struct ow_ast_FuncStmt *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_Module_dump(
		const struct ow_ast_Module *node, size_t level, struct ow_stream *out) {
	const char *const name = ow_ast_node_name((const struct ow_ast_node *)node);
	print_node_begin_tag(name, &node->location, level, out);
...
static void ow_ast_node_dump(
			const struct ow_ast_node *node, size_t level, struct ow_stream *out) {
	switch (node->type) {
