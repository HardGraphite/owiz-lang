...
set(ow_mod_util_conf_list_doc "`*' represents all modules; prefix `-' means disable this module.")
...
function(ow_mod_util_process_conf_list conf_list result_var)
	...
	foreach(entry IN LISTS conf_list)
		if(entry STREQUAL "*")
			set(result_list ${OW_AVAILABLE_MODULES})
		elseif(entry MATCHES "^-.+")
			list(REMOVE_ITEM result_list ${entry})
		else()
	...
	foreach(name IN LISTS result_list)
		set(dep_mods "OW_MOD_${name}_DEP_MODS")
		if(${dep_mods})
...
function(ow_mod_util_collect_dynamic_modules conf_list out_var)
	...
	endforeach()
	set(${out_var} ${embedded_module_list} PARENT_SCOPE)
endfunction()
...
function(ow_mod_util_add_sources target scope mod_name)
	...
	set(sources "OW_MOD_${mod_name}_SOURCES")
	if(${sources})
...
function(ow_mod_util_link_libraries target scope mod_name)
	set(link_libs "OW_MOD_${mod_name}_LINK_LIBS")
	if(${link_libs})
